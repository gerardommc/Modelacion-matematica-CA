...
Donde $r$ es la tasa reproductiva de la población y utilizamos $N$ en lugar de $y$ para representar al número de individuos, y $t$ en lugar de $x$ para dejar claro que las unidades de $x$ representan al tiempo. Si utilizamos el conocimiento de la subsección anterior, veremos que al aplicar el logaritmo a ambos lados de la ecuación \@ref(eq:poblac) obtenemos ¡una ecuación lineal!
